    ...
    <section className="py-24 bg-stone-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-jb-blue text-sm font-bold uppercase tracking-[0.2em] mb-4">
            Testimonios
          </h2>
          ...
          <p className="mt-4 text-lg text-stone-600 max-w-2xl mx-auto">
            Historias de éxito que nos inspiran a seguir innovando y entregando
            excelencia.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          {currentTestimonials.map((testimonial, index) => (
            ...
            >
              <Quote
                className="absolute top-6 right-6 text-stone-100 group-hover:text-jb-blue/5 transition-colors"
                size={60}
              />
        ...
        <div className="max-w-3xl mx-auto mb-24">
          <div className="text-center mb-12">
            ...
            <p className="text-stone-600">
              Tu opinión nos ayuda a mejorar cada día. Déjanos tu reseña y forma
